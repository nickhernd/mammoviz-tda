...
//
void ITK_ABI_IMPORT GDCMImageIOFactoryRegister__Private();void ITK_ABI_IMPORT MetaImageIOFactoryRegister__Private();
...
void (* const ImageIOFactoryRegisterRegisterList[])(void) = {
  GDCMImageIOFactoryRegister__Private,MetaImageIOFactoryRegister__Private,
  nullptr};

...
src/mammoviz: libimgui.a \
  /home/nickhernd/Desktop/mammoviz-tda/third_party/onnxruntime/lib/libonnxruntime.so \
  /usr/lib/Scrt1.o \
  /usr/lib/crti.o \
  /usr/lib/crtn.o \
  /usr/lib/libc.so \
  ...
  /usr/lib/libgdcmCommon.so.3.2 \
  /usr/lib/libgdcmDICT.so.3.2 \
  /usr/lib/libgdcmDSED.so.3.2 \
  /usr/lib/libgdcmIOD.so.3.2 \
  /usr/lib/libgdcmMSFF.so.3.2 \
  /usr/lib/libgdcmcharls.so.2 \
  /usr/lib/libgdcmjpeg12.so.3.2 \
  /usr/lib/libgdcmjpeg16.so.3.2 \
  /usr/lib/libgdcmjpeg8.so.3.2 \
  ...
  src/libmammoviz_io.a \
  src/libmammoviz_nn.a \
  src/libmammoviz_render.a \
  src/libmammoviz_tda_lib.a \
  src/libmammoviz_ui.a \
  src/libmammoviz_utils.a \
  src/libmammoviz_xai.a
